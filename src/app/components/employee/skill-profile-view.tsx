...
// // // 1. Props-ын төрлийг тодорхойлно
// // interface SkillProfileProps {
// //   userId: number;
// //   employeeName: string;
// //   employeeRole: string;
...
// // // 2. Функц дээрээ props-оо хүлээж авна
// // export default function SkillProfilePage({
// //   userId,
// //   employeeName,
// //   employeeRole,
...
// //       <main className="mx-auto max-w-5xl px-4 py-8 sm:px-6 space-y-8">
// //         <section className="rounded-xl border border-border bg-card p-6 shadow-sm">
// //           {/* 3. Гараас бичсэн утгуудын оронд props-оо дамжуулна */}
// //           <EmployeeHeader
// //             name={employeeName}
// //             role={employeeRole}
// //             team={employeeTeam}
...
// //               </h2>
// //               <p className="text-sm text-muted-foreground">
// //                 {skills.length} skills tracked (User ID: {userId})
// //               </p>
// //             </div>
// //             <Button onClick={openAdd} className="gap-2 shadow-sm">
// //               <Plus className="h-4 w-4" /> Add Skill
